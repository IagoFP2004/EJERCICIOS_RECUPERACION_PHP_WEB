<div class="col-12">
    <div class="card shadow mb-4">
        <form method="post" action="/categoria/edit/<?php echo $categorias['id_categoria'] ?>">
                ...
                <div class="row">
                    <div class="col-12 col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="nombre" id="nombre" value="<?php echo $categorias['nombre_categoria'] ?? ''?>">
