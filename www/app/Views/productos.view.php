                            ...
                            <tbody>
                                <?php foreach ($productos as $producto){ ?>
                                    <tr>
                                        ...
                                        <td><a href="<?php echo $_ENV['host.folder'].'productos/edit/'.$producto['codigo'] ?>" target="_blank" class="btn btn-success ml-1" data-toggle="tooltip" data-placement="top" title="" data-original-title="931506210"><i class="fas fa-pen"></i></a></td>
